  ...
  <div class="container">
    ...
    <div class="product-listing">
      ...
      if(isset($_GET['search'])){
        ...
        // define a query
        $q = "SELECT name, category, stock, cost, username, description, discounted, discounted_amount, product_id, image FROM product_master WHERE deleted = 'no' AND (name LIKE '%" . $search_term . "%' OR category LIKE '%" . $search_term . "%' OR stock LIKE '%" . $search_term . "%' OR cost LIKE '%" . $search_term . "%' OR username LIKE '%" . $search_term . "%')";
