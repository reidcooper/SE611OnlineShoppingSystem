    ...
    <div class="add-product col-md-6 col-md-offset-3">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="category" class="form-control" id="InputCategory1" name="category" placeholder="Enter Category" value="<?php if(isset($_POST['category'])){ echo $_POST['category'];} else { echo $category;}?>">
        </div>
        <div class="form-group">
