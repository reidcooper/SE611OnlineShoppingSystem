...
<body>
  ...
  <div class="container">
    ...
    <div class="user-starter-template">
      ...
      // define a query
        $q = "SELECT *, transactions.username AS buyer FROM transactions INNER JOIN product_master ON transactions.product_id = product_master.product_id WHERE transactions.vendor = '$uname' ORDER BY trans_date";
